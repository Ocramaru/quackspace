...
from .core import DatasetPolicy, Space, find_root, scan_signature
...
def _fast_noop(
    ...
    *,
    ...
    files, folders_now, newest_marker_ns = scan_signature(
        root, dataset_policy=dataset_policy, progress=progress
    )
...
def reindex(
    ...
    * **full** — a file was added/removed or its name/body/description changed:
    ...
    noop = _fast_noop(
        root, store_body=store_body, dataset_policy=dataset_policy, progress=progress
    )
    if noop is not None:
